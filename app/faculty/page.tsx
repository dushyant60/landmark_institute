    ...
    <>
      ...
      <div className="hero" style={{ padding: '60px 0 40px', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          <span className="hero-badge">LANDMARK INSTITUTE · NEW DELHI</span>
      ...
      <section style={{ padding: '60px 0 80px', background: 'var(--bg)' }}>
        <div className="container">
          <div className="faculty-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '30px' }}>
            {facultyList.map((f) => (
              <div
