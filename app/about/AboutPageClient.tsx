...
const pillarGridVariants: Variants = {
  hidden: {},
  show: {
    transition: { staggerChildren: 0.1 },
  },
  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .timeline-section {
          margin-bottom: 70px;
          overflow: hidden; /* prevents timeline x-scroll scrollbars on entry scale */
        }
        .timeline-title {
          text-align: center;
          font-family: 'Poppins', sans-serif;
      ...
      <section className="about-section">
        <div className="container">
          ...
          <div className="pillars-section">
            ...
            >
              {pillars.map((pillar) => (
                <motion.div className="pillar-card" key={pillar.title} variants={pillarCardVariants}>
