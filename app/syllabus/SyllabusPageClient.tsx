			...
			<div className="hero" style={{ padding: '56px 0 0', overflow: 'hidden' }}>
				<div className="hero-inner">
					...
					>
						...
						<motion.div variants={fadeUp} className="hero-btns" style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '48px' }}>
					...
					<div className="page-content-grid">
						...
						<div>
							...
							>
								{/* Intro Image */}
								<img
									src="/images/migrated/NIMCET-Syllabus-2026-Mca-Entrance-Exam-Syllabus-Updated​.jpeg"
									alt="NIMCET Syllabus covering Mathematics, Logical Reasoning, Computer Awareness, English, and MCA Entrance Exam Pattern"
									style={{ maxWidth: '100%', height: 'auto', borderRadius: 'var(--r-sm)', margin: '24px 0', display: 'block' }}
								/>
								...
								<div className="video-wrapper">
									<iframe
										src="https://www.youtube.com/embed/40H_dN1Mmhw?si=2KHBIZbNjlB3N5yF"
								...
								<div className="table-scroll">
									<table>
										<tbody>
											<tr><th><strong>Particulars</strong></th><th><strong>Details</strong></th></tr>
											<tr><td>Exam Name</td><td>NIMCET</td></tr>
											<tr><td>Full Form</td><td>NIT MCA Common Entrance Test</td></tr>
											<tr><td>Exam Level</td><td>National Level</td></tr>
											<tr><td>Course Offered</td><td>Master of Computer Applications (MCA)</td></tr>
											<tr><td>Mode of Examination</td><td>Computer-Based Test (CBT)</td></tr>
											<tr><td>Duration</td><td>2 Hours</td></tr>
											<tr><td>Question Type</td><td>Multiple Choice Questions (MCQs)</td></tr>
											<tr><td>Admission Process</td><td>Based on NIMCET Rank</td></tr>
										</tbody>
									</table>
								</div>
									...
									<table>
										<thead>
											<tr>
												...
												<th><strong>No. of Questions</strong></th>
												<th><strong>Marks/Question</strong></th>
												<th><strong>Total Marks</strong></th>
												<th><strong>Negative Marking</strong></th>
											</tr>
										</thead>
										<tbody>
											<tr><td>Mathematics</td><td>50</td><td>12</td><td>600</td><td>-3</td></tr>
											<tr><td>Analytical Ability &amp; Logical Reasoning</td><td>40</td><td>6</td><td>240</td><td>-1.5</td></tr>
											<tr><td>Computer Awareness</td><td>20</td><td>6</td><td>120</td><td>-1.5</td></tr>
											<tr><td>General English</td><td>10</td><td>4</td><td>40</td><td>-1</td></tr>
											<tr><td><strong>Total</strong></td><td><strong>120</strong></td><td>—</td><td><strong>1000</strong></td><td>—</td></tr>
										</tbody>
									</table>
								</div>
								...
								<p>The <strong>NIMCET exam syllabus</strong> is divided into four major sections:</p>
								<ul><li>Mathematics</li><li>Logical Reasoning</li><li>Computer Awareness</li><li>General English</li></ul>
								<p>The <strong>MCA NIMCET syllabus</strong> places significant emphasis on Mathematics, making it the most important subject for candidates targeting a top rank.</p>

								<h2><strong>NIMCET Syllabus (Subject-Wise)</strong></h2>
								<p>The latest <strong>NIMCET syllabus</strong> consists of multiple topics from Mathematics, Reasoning, Computer Awareness, and English.</p>
								...
								<h3>Algebra</h3>
								<ul><li>Linear Equations</li><li>Quadratic Equations</li><li>Progressions</li><li>Logarithms</li><li>Complex Numbers</li><li>Permutations and Combinations</li></ul>
								<h3>Calculus</h3>
								<ul><li>Limits</li><li>Continuity</li><li>Differentiation</li><li>Applications of Derivatives</li><li>Integration</li><li>Definite and Indefinite Integrals</li></ul>
								<h3>Trigonometry</h3>
								<ul><li>Trigonometric Ratios</li><li>Trigonometric Identities</li><li>Heights and Distances</li><li>Inverse Trigonometric Functions</li></ul>
								<h3>Coordinate Geometry</h3>
								<ul><li>Straight Lines</li><li>Circles</li><li>Parabolas</li><li>Ellipses</li><li>Hyperbolas</li></ul>
								<h3>Probability and Statistics</h3>
								<ul><li>Probability Concepts</li><li>Conditional Probability</li><li>Mean, Median, and Mode</li><li>Standard Deviation</li><li>Variance</li></ul>
								<h3>Matrices and Determinants</h3>
								<ul><li>Matrix Operations</li><li>Determinants</li><li>Inverse of Matrix</li><li>Applications of Matrices</li></ul>
								...
								<p>The Logical Reasoning section assesses a candidate&apos;s analytical and problem-solving abilities. <strong>Important topics include:</strong></p>
								<ul><li>Number Series</li><li>Letter Series</li><li>Coding-Decoding</li><li>Blood Relations</li><li>Direction Sense</li><li>Ranking</li><li>Seating Arrangement</li><li>Puzzles</li><li>Analogies</li><li>Statement and Conclusion</li><li>Syllogism</li></ul>
								...
								<ul><li>Computer Fundamentals</li><li>Input and Output Devices</li><li>Operating Systems</li><li>Computer Networks</li><li>Internet Basics</li><li>Database Management Systems</li><li>Software Concepts</li><li>Hardware Concepts</li><li>Programming Fundamentals</li><li>Memory Management</li></ul>

								<h2>General English Syllabus</h2>
								<p>The English section evaluates language skills, vocabulary, and comprehension ability.</p>
								<h3>Topics Covered</h3>
								<ul><li>Grammar</li><li>Vocabulary</li><li>Synonyms and Antonyms</li><li>Sentence Correction</li><li>Reading Comprehension</li><li>Error Detection</li><li>Fill in the Blanks</li><li>Para Jumbles</li></ul>

								<h2>Subject-Wise Preparation Strategy</h2>
								<h3>Mathematics</h3>
								<ul><li>Practice daily.</li><li>Solve previous year questions.</li><li>Maintain a formula notebook.</li><li>Focus on conceptual understanding.</li></ul>
								<h3>Logical Reasoning</h3>
								<ul><li>Solve puzzles regularly.</li><li>Practice reasoning sets under timed conditions.</li><li>Improve analytical thinking skills.</li></ul>
								<h3>Computer Awareness</h3>
								<ul><li>Revise computer fundamentals.</li><li>Cover networking and operating system basics.</li><li>Review important technical concepts weekly.</li></ul>
								<h3>English</h3>
								<ul><li>Read newspapers regularly.</li><li>Improve vocabulary.</li><li>Practice grammar exercises.</li><li>Solve comprehension passages.</li></ul>

								<h2>NIMCET Previous Year Paper Analysis</h2>
								<p><strong>Recent exam trends indicate:</strong></p>
								<ul><li>Mathematics remains the highest-priority section.</li><li>Logical Reasoning questions are becoming more analytical.</li><li>Computer Awareness focuses on fundamental concepts.</li><li>English questions are generally moderate in difficulty.</li></ul>
								<p><strong>Previous year papers help students understand:</strong></p>
								<ul><li>Question patterns</li><li>Topic importance</li><li>Difficulty level</li><li>Time management requirements</li></ul>

								<h2><strong>NIMCET Preparation Plan</strong></h2>
								<h3>Phase 1: Foundation Building (Months 1–2)</h3>
								<ul><li>Complete Mathematics fundamentals.</li><li>Cover basic reasoning concepts.</li><li>Begin Computer Awareness preparation.</li></ul>
								<h3>Phase 2: Concept Strengthening (Months 3–4)</h3>
								<ul><li>Solve topic-wise practice questions.</li><li>Attempt sectional mock tests.</li><li>Improve weak areas.</li></ul>
								<h3>Phase 3: Advanced Practice (Months 5–6)</h3>
								<ul><li>Solve previous year papers.</li><li>Attempt full-length mock tests.</li><li>Focus on revision and accuracy.</li></ul>

								<h2>Common Mistakes to Avoid</h2>
								<ul><li>Ignoring Mathematics preparation</li><li>Not attempting mock tests</li><li>Poor time management</li><li>Memorizing concepts without understanding them</li><li>Skipping revision</li><li>Neglecting previous year papers</li></ul>
								...
								<ul><li>Experienced MCA entrance faculty</li><li>Structured classroom and online programs</li><li>Comprehensive study material</li><li>Regular mock test series</li><li>Doubt-clearing sessions</li><li>Performance analysis and mentorship</li></ul>
								...
								<ul><li>Software Developer</li><li>Full Stack Developer</li><li>Data Analyst</li><li>Cloud Engineer</li><li>Cyber Security Analyst</li><li>Database Administrator</li><li>System Engineer</li><li>Application Developer</li></ul>

								<h2><strong>Conclusion</strong></h2>
								<p>The <strong>NIMCET syllabus</strong> is designed to evaluate a candidate&apos;s aptitude in Mathematics, Logical Reasoning, Computer Awareness, and English. A clear understanding of the <strong>MCA entrance exam syllabus</strong>, combined with knowledge of the <strong>NIMCET exam pattern</strong>, can help students prepare more effectively and increase their chances of securing admission to a prestigious NIT MCA program.</p>
							</motion.div>
